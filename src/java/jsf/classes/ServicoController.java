...
import beans.sessions.ServicoFacade;
...
public class ServicoController implements Serializable {
    ...
    @EJB
    private beans.sessions.ServicoFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Servico) getItemsList().getRowData();
    ...
    public static class ServicoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Servico) {
                ...
                return getStringKey(o.getCdServico());
            } else {
